...
<main>
  ...
  <div class="tecnology-tags">
    <span>
      <svg
        ...
        style="width: 18px;height: 18px;filter: grayscale(1);border-radius: 5px;"
    ...
    <span>
      <svg
        ...
        fill="none"
        viewBox="0 0 242 256"
        style="width: 20px;height: 20px;filter: grayscale(1) brightness(1.45);"
        ><g clip-path="url(#a)"
          ><mask
            id="b"
            width="242"
        ...
        ><defs
          ><linearGradient
            ...
            ><stop stop-color="#E40035"></stop><stop
              offset=".2"
              stop-color="#F60A48"
            ></stop><stop offset=".4" stop-color="#F20755"></stop><stop
              offset=".5"
              stop-color="#DC087D"
            ></stop><stop offset=".7" stop-color="#9717E7"></stop><stop
              offset="1"
              stop-color="#6C00F5"
            ></stop></linearGradient
          >
  ...
  <p>
    Check out <a
      ...
      target="_blank"
      rel="noreferrer">FlexiUI</a
    >, the official Flexi CMS component library.
  </p>
